...
main = require('./gulp/main')(_, gulp, coffee, concat, rename, log, clean, gulpif, coffeelint, serve, ignore, es,
    debug, help, ourUtils, replace, gzip, tar, insert, mocha, ourPackage, karma, open)

karma = require('./gulp/karma')(_, gulp, coffee, concat, rename, log, clean, gulpif, coffeelint, serve, ignore, es,
